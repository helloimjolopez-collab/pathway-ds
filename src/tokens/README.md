...
**The colour contract is 249 names.** Not 984, which is what you get if you add up
...
| `themes/light.css` | 249 | **Contract** | Yes |
| `themes/midnight.css` | 249 | **Contract** (same names as light) | Yes |
...
**Your working vocabulary is 359 names** — 249 colour + 41 type + 39 layout + 17 motion
...
2. **Are they in the CSS?** Yes, and they have to be. All 249 semantics resolve via
