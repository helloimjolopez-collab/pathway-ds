...
**The colour contract is 171 names.** Not 966, which is what you get if you add up
...
| `themes/light.css` | 171 | **Contract** | Yes |
| `themes/midnight.css` | 171 | **Contract** (same names as light) | Yes |
| `type.css` | 41 | **Contract** | Yes |
| `layout.css` | 40 | **Contract** | Yes |
| `layout-responsive.css` | 8 | **Contract** (the only layout tokens with media queries) | Yes |
| `layout-contextual.css` | 28 | Component internals | Prefer `layout.css` |
| `motion.css` | 17 | **Contract** | Yes |
| `breakpoints.css` | 5 | **Contract** | Yes |

**Your working vocabulary is 269 names** — 171 colour + 41 type + 40 layout + 17 motion
...
2. **Are they in the CSS?** Yes, and they have to be. All 171 semantics resolve via
