...
**The colour contract is 268 names.** Not 1,022, which is what you get if you add up
...
| `themes/light.css` | 268 | **Contract** | Yes |
| `themes/midnight.css` | 268 | **Contract** (same names as light) | Yes |
...
**Your working vocabulary is 378 names** — 268 colour + 41 type + 39 layout + 17 motion
...
2. **Are they in the CSS?** Yes, and they have to be. All 268 semantics resolve via
