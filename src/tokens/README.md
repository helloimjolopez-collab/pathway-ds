...
**The colour contract is 288 names.** Not 1,064, which is what you get if you add up
...
| `themes/light.css` | 288 | **Contract** | Yes |
| `themes/midnight.css` | 288 | **Contract** (same names as light) | Yes |
...
**Your working vocabulary is 398 names** — 288 colour + 41 type + 39 layout + 17 motion
...
2. **Are they in the CSS?** Yes, and they have to be. All 288 semantics resolve via
