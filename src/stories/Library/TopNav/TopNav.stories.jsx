...
export const TokensFill = {
  ...
  render: () => (
    <TokenTable title="Fill tokens" rows={[
      <TokenRow key="brand"   varName="--semantic-color-fill-static-brand-subtle"         fallback="#2d4889"               label="Nav bar background" />,
      ...
      <TokenRow key="avbg"   varName="--semantic-color-fill-static-accent-amethyst-subtle" fallback="#dcd9ef"               label="Profile avatar background" />,
    ]} />
  ),
...
export const TokensStroke = {
  ...
  parameters: { docs: { description: { story: "Stroke tokens. There is no Tertiary stroke family any more - it was deleted because it duplicated Primary offset by one ramp step, so the OrgSwitcher border reads the Primary stroke ramp. The search pill uses Foreground/Static/Neutral/Mono at 0.75px." } } },
};
...
export const TokensIcon = {
  ...
  render: () => (
    <TokenTable title="Icon tokens" rows={[
      <TokenRow key="icomono" varName="--semantic-color-foreground-static-neutral-mono" fallback="#fbfbfb" label="All icons on nav bar surface" type="icon" />,
    ]} />
  ),
  parameters: { docs: { description: { story: "Icon tokens. All Material Symbol icons on the brand-blue surface use Foreground/Static/Neutral/Mono." } } },
};
