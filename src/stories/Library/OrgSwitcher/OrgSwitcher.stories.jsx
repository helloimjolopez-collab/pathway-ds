...
export const TokensFill = () => (
  <LiveTokenTable
    ...
    rows={[
      { token: "fill.action.primary.subtle.rest",    usage: "Trigger background - rest. Primary/Subtle replaced the deleted Tertiary ramp" },
...
export const TokensForeground = () => (
  <LiveTokenTable
    ...
    rows={[
      ...
      { token: "foreground.static.neutral.base",    usage: "Dropdown secondary line" },
      { token: "foreground.static.neutral.base",    usage: "Dropdown section label" },
    ]}
  />
);
