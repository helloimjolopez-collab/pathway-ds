...
tokens/pathway-design-tokens.json                        │
  ...
  └──────────────────────────┬────────────────────────────┘
        ...
        src/tokens/themes/light.css        290 semantic colours, :root + [data-theme=light]
        src/tokens/themes/midnight.css     the same 290 names under [data-theme=midnight]
...
| `themes/light.css` + `themes/midnight.css` | 290 semantic colour names, one name per token, mode by selector | **Yes.** This is the colour contract |
