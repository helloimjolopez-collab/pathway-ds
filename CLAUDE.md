...
tokens/pathway-design-tokens.json                        │
  ...
  └──────────────────────────┬────────────────────────────┘
        ...
        src/tokens/themes/light.css        288 semantic colours, :root + [data-theme=light]
        src/tokens/themes/midnight.css     the same 288 names under [data-theme=midnight]
...
| `themes/light.css` + `themes/midnight.css` | 288 semantic colour names, one name per token, mode by selector | **Yes.** This is the colour contract |
