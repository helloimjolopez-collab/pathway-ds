...
|---|---|---|
| `themes/light.css` | **298** | **Yes** — this is the colour contract |
| `themes/midnight.css` | 298 | Yes — the *same* names, different values |
| `type.css` | 41 | Yes |
| `layout.css` | 39 | Yes |
| `motion.css` | 17 | Yes |
...
## Why 298 and not 1,082

If you add up every declaration across the token folder you get 1,082. That number is
real and it is not the contract:

- **The two theme files declare the same 298 names**, once each. One name, two values,
