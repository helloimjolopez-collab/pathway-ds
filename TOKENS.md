...
|---|---|---|
| `themes/light.css` | **162** | **Yes** — this is the colour contract |
| `themes/midnight.css` | 162 | Yes — the *same* names, different values |
| `type.css` | 41 | Yes |
| `layout.css` | 40 | Yes |
| `motion.css` | 17 | Yes |
...
- **The two theme files declare the same 162 names**, once each. One name, two values,
