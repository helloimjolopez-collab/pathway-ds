...
| 9 primitive references in a draft | RESOLVED 2026-09-16. `components/search/SEARCH-SPEC-TO-REVIEW.md` documented a raw primitive palette whose slot numbers no longer existed. It was the May 2026 handoff package, superseded by the REVIEWED `search-spec.md`, which is a superset and carries its own gaps section. Deleted in the one-doc-per-component tidy-up. |
