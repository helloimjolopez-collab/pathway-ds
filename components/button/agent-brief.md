...
All values via CSS custom properties from `themes/light.css` + `themes/midnight.css` (colour), `layout.css` (spacing), `type.css` (the type scale), `motion.css`, `breakpoints.css`.
