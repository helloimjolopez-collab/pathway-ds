...
5. **Use semantic tokens for the fill, stroke, and check icon.** The check icon is `Foreground/Neutral/Mono` (white on brand-blue fill when checked). Never hardcode.
