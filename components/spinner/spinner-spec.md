...
| `info` | `foreground.static.info.on-subtle` | `amethyst-700` | `#353063` |
| `warning` | `foreground.static.attention.on-subtle` | `saffron-700` | `#342d21` |
...
| `accent-amethyst` | `foreground.static.info.on-subtle` | `amethyst-700` | `#353063` |
| `accent-jade` | `foreground.static.accent.jade.on-subtle` | `jade-700` | `#10423b` |
