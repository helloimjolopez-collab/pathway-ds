...
> of the 377 names you may use, and what to link in what order.

## Using the tokens

**The colour contract is 267 names. Your full working vocabulary is 377.**

That is the number worth knowing, because adding up every declaration in the token
folder gives 1,020 and the retired `tokens.css` used to emit 2,338. Neither is the
...
| | Count | Name these? |
|---|---|---|
| Colour (`themes/light.css`, `themes/midnight.css` — same names) | **267** | Yes |
